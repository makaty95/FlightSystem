...
public class User {
    ...
    public void searchFlight() {
        ...
        do{
            flag = false;
            departureAirport.setArrivalAirportLocation();
            arrivalAirport.setArrivalAirportLocation();;


            // Search by Departure airport and arrival airport in the Arraylist
            for (FlightDetails search : data) {
                if (search.departureLocation.equals(departureAirport.getArrivalAirportLocation()) && search.arrivalLocation.equals(arrivalAirport.getArrivalAirportLocation())) {
        ...
        selectFlight(departureAirport.getDepartureAirportLocation() , arrivalAirport.getArrivalAirportLocation()  );
    }
    ...
    public void selectFlight(String departureLocationEnter , String arrivalLocationEnter ) {
        ...
        while  (true){
            ...
            for (FlightDetails f : data){
                if (f.flightNum.equals(flightnumenter) && f.departureLocation.equals(departureAirport.getArrivalAirportLocation()) && f.arrivalLocation.equals(arrivalAirport.getDepartureAirportLocation())){
                    flightInfo = f;
